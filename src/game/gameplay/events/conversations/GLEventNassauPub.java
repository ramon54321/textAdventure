...
public class GLEventNassauPub extends GLiveEvent implements Runnable{
    ...
    public void run() {
        ...
        if(GMain.mainGGame.mainWorldData.worldFlags.contains(GWorldData.GFlags.mission5_FoughtSingleton)){
            GMain.mainGGame.mainGFrame.consoleClear();
            GMain.mainGGame.mainGFrame.consoleAddLine("**************");
            GMain.mainGGame.mainGFrame.consoleAddLine("TO BE CONTINUED");
            GMain.mainGGame.mainGFrame.consoleAddLine("**************");
            try {Thread.sleep(2500);} catch (Exception e) {}
            GMain.mainGGame.mainGFrame.consoleAddLine("Thank you for playing!");
            try {Thread.sleep(2500);} catch (Exception e) {}
            GMain.mainGGame.mainGFrame.consoleAddLine("See you in episode 2! Only five euros!");
            try {Thread.sleep(2500);} catch (Exception e) {}
            ...
            while (true) {
                if (GFrame.getInput().equals("1")) {
                    ...
                    GMain.mainGGame.mainGFrame.consoleAddLine("(No, you landlubber. I said type \"1\".)");
                }
            }
        }
        else {
